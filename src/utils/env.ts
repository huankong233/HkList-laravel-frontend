...
export const getLoginRole = () => localStorage.getItem('login_role') ?? 'user'

export const setLoginRole = (role: 'user' | 'admin') => localStorage.setItem('login_role', role)

export const getRemberAnnounce = () => localStorage.getItem('announce') ?? ''

export const setRemberAnnounce = (announce: string) => localStorage.setItem('announce', announce)
